...
const ScheduleItem: React.FC<ScheduleItemProps> = (props) => {
  ...
  return (
    <article
      ...
      } w-[638px] h-[70px] rounded-[5px] flex justify-between items-center p-[20px] mb-[10px]`}
    >
      <div className="w-[80%] flex items-center ">
        ...
        {editing ? (
          ...
          <div className="border-solid border-2 border-green-500 w-[60%] h-[25px] overflow-hidden ">
